 ...
 * Players Routes
 * 
 * This file defines all player-specific routes for finding and contacting players.
 * These routes are separate from user management and focus on player matching functionality.
 * 
...
/**
 * @route   POST /players/:playerId/contact
 * @desc    Contact a player for match request
 * @access  Private
 */
router.post('/:playerId/contact', 
  authenticateToken,
